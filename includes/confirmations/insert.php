...
$confirmation_dt = mysqli_real_escape_string($link, $_REQUEST['confirmation_dt']);
...
$sql = "INSERT INTO confirmation (fname,mname,lname,m_fname,m_mname,m_lname,f_fname,f_mname,f_lname,birthdate, confirmation_dt,appointment_dt) VALUES ('$fname','$mname','$lname','$m_fname','$m_mname','$m_lname','$f_fname','$f_mname','$f_lname','$birthdate','$confirmation_dt','$appointment_dt')";
