...
$requiem_dt = mysqli_real_escape_string($link, $_REQUEST['requiem_dt']);
...
$deathdate = mysqli_real_escape_string($link, $_REQUEST['deathdate']);

// Attempt insert query execution
$sql = "INSERT INTO requiem (fname,mname,lname,m_fname,m_mname,m_lname,f_fname,f_mname,f_lname,birthdate,deathdate, requiem_dt,appointment_dt) VALUES ('$fname','$mname','$lname','$m_fname','$m_mname','$m_lname','$f_fname','$f_mname','$f_lname','$birthdate','$deathdate','$requiem_dt','$appointment_dt')";
